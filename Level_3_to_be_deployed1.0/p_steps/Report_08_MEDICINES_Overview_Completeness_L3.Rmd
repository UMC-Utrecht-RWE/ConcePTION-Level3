...
flowchart_med<-fread(paste0(med_dir,"Masked/", "medicines_flowchart_masked.csv"))
datatable(flowchart_med, options = list(scrollX=T))
} else {
flowchart_med<-fread(paste0(med_dir,subpopulations_names[a], "/Masked/", subpopulations_names[a],"_medicines_flowchart_masked.csv"))
datatable(flowchart_med, options = list(scrollX=T))
}
```
...
if (subpopulations_present=="No"){
description_med<-fread(paste0(med_dir,"Masked/", "medicines_description_masked.csv"))
datatable(description_med, options = list(scrollX=T))
} else {
  description_med<-fread(paste0(med_dir,subpopulations_names[a], "/Masked/", subpopulations_names[a],"_medicines_description_masked.csv"))
datatable(description_med, options = list(scrollX=T))
}
```
...
tab15_med<-fread(paste0(med_dir,"Masked/", "medicines_completeness_masked.csv"))
if (tab15_med[,.N]>0){
datatable(tab15_med, options = list(scrollX=T))
  ...
  tab15_med<-fread(paste0(med_dir,subpopulations_names[a], "/Masked/", subpopulations_names[a],"_medicines_completeness_masked.csv"))
  if (tab15_med[,.N]>0){
datatable(tab15_med, options = list(scrollX=T))
  } else {
    tab15_med<-NULL
